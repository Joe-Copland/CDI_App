...
if len(stats)>=number_of_tests*6:
    ...
    axs2[0].errorbar(payload_size_plot,latency_plot,yerr=latency_plot_err,fmt='.k', capsize=3)
    ...
    axs2[1].errorbar(payload_size_plot,packet_rate_plot,yerr=packet_rate_plot_err,label="Packet Rate",fmt='.k', capsize=3)
    axs2[1].errorbar(payload_size_plot,transmission_rate_plot,yerr=transmission_rate_plot_err,label="Transmission Rate",fmt='.k', capsize=3)
