...
if len(stats)>=number_of_tests*8:
    ...
    ax1.plot(fourk_x,fourk_y,linestyle='--',color='green',label="4K 60fps 3BpPix Equivalent")
    ax1.plot(HD_x,fourk_y,linestyle='--',color='purple',label="1080p 60fps 3BpPixel Equivalent")
    ax1.legend()
    ax2.plot(fourk_x,fourk_y,linestyle='--',color='green')
    ax2.plot(HD_x,fourk_y,linestyle='--',color='purple')
    ax3.plot(fourk_x,fourk_y,linestyle='--',color='green')
    ax3.plot(HD_x,fourk_y,linestyle='--',color='purple')
    plt.subplots_adjust(wspace=0, hspace=0)
