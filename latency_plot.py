...
if len(stats)>=number_of_tests*6:
    ...
    axs2[1].errorbar(payload_size_plot,packet_rate_plot,yerr=packet_rate_plot_err,label="Packet Rate",fmt='none', capsize=3)
    axs2[1].errorbar(payload_size_plot,transmission_rate_plot,yerr=transmission_rate_plot_err,label="Transmission Rate",fmt='none', capsize=3)
